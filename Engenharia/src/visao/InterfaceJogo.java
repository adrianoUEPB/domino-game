		...
		if (part.id_lastWin == -1){
			...
			if(part.jogadorDaVez == 0){	// jogador
				...
				if (quantidadeCarrocao == 0){ // passa a vez
					JOptionPane.showMessageDialog(jogadorPecas, part.participantes.get(part.jogadorDaVez).getNome() + " ṇo tem carro̤̣o para iniciar, enṭo passou a vez!", "Passou a vez", JOptionPane.INFORMATION_MESSAGE);
							...
							public void mousePressed(MouseEvent e){
								...
								if (vencedor == null){
									...
									if (x == 1){
										...
										mensagem = vencedor.getNome() + " venceu a partida com um carro̤̣o!\n\n";
									} else if (x == 3){
